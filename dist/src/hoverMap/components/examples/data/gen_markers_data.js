...
var _mersenne = require('faker/vendor/mersenne.js');
...
function imageRndUrl() {
  ...
  var height = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 75;
...
function genMarkersData(_ref) {
  var count = _ref.count,
      seedNumber = _ref.seed,
      latVarM = _ref.latVarM,
      lngVarM = _ref.lngVarM,
      test = _ref.test,
      typeGetter = _ref.typeGetter;

  (0, _mersenne.seed)(seedNumber);
  var K_P_COUNT = 10;
...
//# sourceMappingURL=gen_markers_data.js.map