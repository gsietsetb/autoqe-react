            ...
            <footer className="footer" id="footer">
                <section className="section section-footer">
                    ...
                    <Row>
                        <Col xs={5} md={3}>
                            <ul><h4>Servicios</h4>
                                <li><img height={25} src={trip}/><Link to="/trips"> Carpooling</Link></li>
                                <li><img height={25} src={car}/><Link to="/carrent"> Alquiler de Autos</Link></li>
                                <li><img height={25} src={park}/><Link to="/parkrent"> Alquiler de Cocheras</Link></li>
                                <li><img height={25} src={elec}/><Link to="/electric"> Autos Eléctricos</Link> <Label
                                    bsStyle="warning">Próx.</Label></li>
                            </ul>
                        </Col>
                        <Col xs={5} md={3}>
                            <ul><h4>Aprendé mas</h4>
                                <li><img height={25} src={hWorks}/><Link to="/howWorks"> ¿Cómo funciona?</Link></li>
                                <li><img height={25} src={quest}/><Link to="/faq"> Preguntas frecuentes</Link></li>
                                <li><img height={25} src={social}/><Link to="/collaborative"> Economía
                                    Colaborativa</Link></li>
                                <li><img height={25} src={leaf}/><Link to="/green"> Huella ecológica</Link></li>
                            </ul>
                        </Col>
                        <Col xs={5} md={3}>
                            <ul><h4> Autoqe</h4>
                                <li><img height={25} src={world}/><Link to="/next"> Próximos paises</Link></li>
                                <li><img height={25} src={design}/><Link to="/design"> Rincón de diseño</Link></li>
                                <li><img height={25} src={code}/><Link to="/dev"> Rincón de Desarrollo</Link></li>
                                <li><img height={25} src={press}/><Link to="/press"> Rincón de Prensa</Link></li>
                            </ul>
                        </Col>
                        <Col xs={5} md={3}>
                            <ul><h4>Contacto</h4>
                                <li><img height={25} src={disc}/><Link to="/promotion"> Promociones</Link></li>
                                <li><img height={25} src={job}/><Link to="/work"> Trabajos </Link><Label
                                    bsStyle="success">Contratando!</Label></li>
                                <li><img height={25} src={team}/><Link to="/team"> Equipo</Link></li>
                                <li><img height={25} src={world}/><Link to="/contact"> Contacto</Link></li>
                            </ul>
                        </Col>
